    ...
    private func setupTableData() {
        tableOptions = [
           // TableOption(name: "Simple", viewController: SimpleTableView()),
            ...
            TableOption(name: "Expanding Sections", viewController: ExpandingSectionsVC()),
            TableOption(name: "Featured Header", viewController: FeaturedHeaderVC()),
            TableOption(name: "Searching", viewController: SearchingVC()),
